...
## Run command: 
```python3 main.py -i resources/Pedestrian_Detect_2_1_1.mp4 -m model/frozen_darknet_yolov3_model_tiny_fp16.xml -d CPU -pt 0.2 -lt 2 | ffmpeg -v warning -f rawvideo -pixel_format bgr24 -video_size 768x432 -framerate 24 -i - http://0.0.0.0:3004/fac.ffm```
